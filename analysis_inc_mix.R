...
# =============================================================================
# Diagnostic plots - Increase vs Mix
# =============================================================================
...
hist(
  ...
  main = "AIPW Model 1 (Resample) - Inc vs Mix",
  xlab = "ATT",
  col = "lightblue",
  breaks = 30
)
...
hist(
  ...
  main = "AIPW Model 1 (Reweight) - Inc vs Mix",
  xlab = "ATT",
  col = "lightcoral",
  breaks = 30
)
...
hist(
  ...
  main = "DRS Model 1 (Resample) - Inc vs Mix",
  xlab = "ATT",
  col = "lightgreen",
  breaks = 30
)
...
hist(
  ...
  main = "DRS Model 1 (Reweight) - Inc vs Mix",
  xlab = "ATT",
  col = "lightyellow",
  breaks = 30
)
...
plot(
  ...
  main = "Model 1 AIPW: Resample vs Reweight - Inc vs Mix",
  xlab = "ATT",
  col = "blue",
  lwd = 2,
  xlim = range(c(
...
plot(
  ...
  main = "Model 1 DRS: Resample vs Reweight - Inc vs Mix",
  xlab = "ATT",
  col = "blue",
  lwd = 2,
  xlim = range(c(
...
# Comparison across models for AIPW (Resample) - Increase vs Mix
plot(
  density(results$model1_resample$aipw$bootstrap_samples),
  main = "AIPW Estimates Across Models (Resample) - Inc vs Mix",
  xlab = "ATT",
  col = "blue",
  lwd = 2,
  xlim = range(c(
...
# Comparison across models for AIPW (Reweight) - Increase vs Mix
plot(
  density(results$model1_reweight$aipw$bootstrap_samples),
  main = "AIPW Estimates Across Models (Reweight) - Inc vs Mix",
  xlab = "ATT",
  col = "blue",
  lwd = 2,
  xlim = range(c(
...
# Comparison across models for DRS (Resample) - Increase vs Mix
plot(
  density(results$model1_resample$drs$bootstrap_samples),
  main = "DRS Estimates Across Models (Resample) - Inc vs Mix",
  xlab = "ATT",
  col = "blue",
  lwd = 2,
  xlim = range(c(
...
# Comparison across models for DRS (Reweight) - Increase vs Mix
plot(
  density(results$model1_reweight$drs$bootstrap_samples),
  main = "DRS Estimates Across Models (Reweight) - Inc vs Mix",
  xlab = "ATT",
  col = "blue",
  lwd = 2,
  xlim = range(c(
...
saveRDS(results$model1_resample, "results/model1_resample_inc_mix.rds")
saveRDS(results$model1_reweight, "results/model1_reweight_inc_mix.rds")
saveRDS(results$model2_resample, "results/model2_resample_inc_mix.rds")
saveRDS(results$model2_reweight, "results/model2_reweight_inc_mix.rds")
saveRDS(results$model3_resample, "results/model3_resample_inc_mix.rds")
saveRDS(results$model3_reweight, "results/model3_reweight_inc_mix.rds")
saveRDS(results$model4_resample, "results/model4_resample_inc_mix.rds")
saveRDS(results$model4_reweight, "results/model4_reweight_inc_mix.rds")

# Save entire results list
saveRDS(results, "results/all_results_inc_mix.rds")
...
# Save as CSV
write.csv(summary_table, "results/bootstrap_DR_summary_inc_mix.csv", row.names = FALSE)

cat("\nResults saved successfully!\n")
cat("- Individual results: results/model*_{resample|reweight}_inc_mix.rds\n")
cat("- All results: results/all_results_inc_mix.rds\n")
cat("- Summary table: results/bootstrap_DR_summary_inc_mix.csv\n")