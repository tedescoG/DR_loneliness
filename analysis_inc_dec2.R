...
saveRDS(results$model1_cf2, "results/outcome/inc_dec/model1_cf2.rds")
saveRDS(results$model2_cf2, "results/outcome/inc_dec/model2_cf2.rds")
saveRDS(results$model3_cf2, "results/outcome/inc_dec/model3_cf2.rds")
saveRDS(results$model4_cf2, "results/outcome/inc_dec/model4_cf2.rds")
